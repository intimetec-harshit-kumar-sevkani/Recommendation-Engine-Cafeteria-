...
public interface EmployeeHandler {
    ...
    void handleAddUserProfile(BufferedReader in, PrintWriter out) throws IOException, SQLException;
    void handleUpdateUserProfile(BufferedReader in, PrintWriter out) throws IOException, SQLException;
}
